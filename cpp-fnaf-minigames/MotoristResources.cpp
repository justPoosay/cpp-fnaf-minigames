...
MotoristGameResources LoadMotoristResources(GraphicsQuality quality) {
    ...
    // Car (player & NPC)
    resources.car = LoadTexture("resources/MidnightMotorist/Textures/car.png");

    resources.carSpinFrames.resize(19);
    for (int i = 0; i < 19; i++) {
        string filename = TextFormat("resources/MidnightMotorist/Textures/carSpin_%02d.png", i + 1);
        resources.carSpinFrames[i] = LoadTexture(filename.c_str());
    }

    resources.rightCarNPC = LoadTexture("resources/MidnightMotorist/Textures/leftCarNPC.png");
    resources.leftCarNPC = LoadTexture("resources/MidnightMotorist/Textures/rightCarNPC.png");

    // Background & UI
    resources.bg = LoadTexture("resources/MidnightMotorist/Textures/bg.png");
    resources.one = LoadTexture("resources/MidnightMotorist/Textures/1.png");
    resources.two = LoadTexture("resources/MidnightMotorist/Textures/2.png");
    resources.three = LoadTexture("resources/MidnightMotorist/Textures/3.png");
    resources.go = LoadTexture("resources/MidnightMotorist/Textures/go.png");
    resources.wasd = LoadTexture("resources/MidnightMotorist/Textures/wasd.png");
    resources.lap = LoadTexture("resources/MidnightMotorist/Textures/lap.png");
    resources.lapMark = LoadTexture("resources/MidnightMotorist/Textures/lapMark.png");
    resources.goal = LoadTexture("resources/MidnightMotorist/Textures/goal.png");

    resources.gameFont = LoadFont("resources/ARCADECLASSIC.TTF");


    // Music & FX
    resources.backgroundMusic = LoadMusicStream("resources/MidnightMotorist/Audio/motorist.mp3");
    resources.bgNoise = LoadMusicStream("resources/MidnightMotorist/Audio/bgNoise.wav");
    resources.countdown = LoadSound("resources/MidnightMotorist/Audio/countdown.wav");
    resources.ctdwnGo = LoadSound("resources/MidnightMotorist/Audio/go.wav");
    resources.carCrash = LoadSound("resources/MidnightMotorist/Audio/crash.wav");
    resources.lapReached = LoadSound("resources/MidnightMotorist/Audio/lap.wav");
    resources.goalReached = LoadSound("resources/MidnightMotorist/Audio/goal.wav");
