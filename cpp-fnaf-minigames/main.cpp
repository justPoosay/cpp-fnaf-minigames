...
void DrawMainMenuScreen(MainMenuResources& res, Vector2 mousePos, int mainMenuBgCurrentFrame, GameScreen& currentScreen, GameScreen& previousScreen, GameScreen& fadeTargetScreen, bool& isFadingOut, float& fadeAlpha) {
    ...
    if (GuiButton({ buttonX, buttonYStart + buttonSpacing, buttonWidth, buttonHeight }, "Midnight Motorist", res.arcadeClassicFont, WHITE, BLUE, PURPLE, mousePos)) {
        previousScreen = currentScreen;
    ...
    if (GuiButton({ buttonX, buttonYStart + buttonSpacing * 2, buttonWidth, buttonHeight }, "Magic Rainbow Land", res.arcadeClassicFont, WHITE, YELLOW, RED, mousePos)) {
        previousScreen = currentScreen;
    ...
    if (GuiButton({ buttonX, buttonYStart + buttonSpacing * 3, buttonWidth, buttonHeight }, "Settings", res.arcadeClassicFont, WHITE, LIGHTGRAY, GRAY, mousePos)) {
    ...
    if (GuiButton({ buttonX, buttonYStart + buttonSpacing * 4, buttonWidth, buttonHeight }, "Exit", res.arcadeClassicFont, WHITE, LIGHTGRAY, GRAY, mousePos)) {
        previousScreen = currentScreen;
